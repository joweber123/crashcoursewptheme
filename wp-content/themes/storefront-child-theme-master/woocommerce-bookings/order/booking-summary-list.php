...
?>
	<ul class="wc-booking-summary-list">
		...
		<?php if ( $resource ) : ?>
			...
			echo 'Zoom Link: '.'<a target="_blank" href="'. $zoomlink . '">'.$zoomlink.'</a>';
			?>
			</li>
			<li>Travel Planning Survey: <a target="_blank" href="https://forms.gle/ujhfP3P9vyHFUWhB6">https://forms.gle/ujhfP3P9vyHFUWhB6</a></li>
		<?php endif; ?>
